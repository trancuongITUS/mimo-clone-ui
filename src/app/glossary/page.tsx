    ...
    <div>
      <div className="flex min-h-screen flex-col items-center justify-between">
        <div className="m-0 flex w-full flex-col items-center justify-between font-mono text-sm ">
          <div className=" bg-transparent z-[1000] w-full relative text-marketing-text-primary">
            <div className="flex h-[80px] w-full items-center justify-between px-6 py-4 tablet:px-10">
              ...
              <div className="flex space-x-10 tablet:flex-grow-0 desktop:flex-1 left-0 right-0">
                <a href="/about-us">
                  <p className="button-header font-normal text-[16px] tablet:text-[16px] font-bold leading-[20px] tablet:text-[18px] tablet:leading-[24px]">
                    About Us
                  </p>
                </a>
                <a href="/blog">
                  <p className=" button-header font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[18px] tablet:leading-[24px] hover:text-marketing-button-primary-hover">
                    Blog
                  </p>
                </a>
                <a href="/glossary" className={styles.select}>
                  <p className="font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[18px] tablet:leading-[24px] hover:text-marketing-button-primary-hover">
                    Glossary
                  </p>
                </a>
              </div>
              <div className="flex space-x-10 tablet:flex-grow-0 desktop:flex-1 left-0 items-center">
                <a href="/login">
                  <p className="button-header text-[14px] font-bold leading-[20px] tablet:text-[18px] tablet:leading-[24px] hover:text-marketing-button-primary-hover">
                    LOG IN
                  </p>
                </a>
                <a href="/register" className={styles.buttonSignUp}>
                  <p className=" font-mimopro text-[14px] font-bold leading-[20px] tablet:text-[18px] tablet:leading-[24px] hover:text-marketing-button-primary-hover">
                    SIGN UP
                  </p>
                </a>
              </div>
            ...
            <div className="relative z-10  w-full  text-marketing-text-primary undefined">
              <div className="absolute bottom-0 left-0 top-0 z-[-1] h-full w-full undefined">
                <div className="h-[30px] w-[30px] tablet:h-[60px] tablet:w-[60px] bg-marketing-accent-yellow absolute left-[60%] top-[75%]">
                  <div className="block bg-marketing-accent-darkBlue  absolute left-[100%] top-[100%]  h-[30px] w-[30px] tablet:h-[60px] tablet:w-[60px]"></div>
                </div>
