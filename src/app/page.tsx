          ...
          <div className="mb-28 w-full max-w-[1364px] flex-1 tablet:mb-40">
            ...
            <section className="mt-20 space-y-6 px-6 tablet:mt-32 tablet:px-10">
              ...
              <div className="relative m-auto flex h-[200px] w-full max-w-[1364px] items-center justify-between space-y-6 rounded-3xl bg-[#7E4BDE] px-8 py-10 text-white tablet:h-[200px] tablet:max-h-[200px] tablet:flex-row tablet:space-y-0 tablet:space-y-6 tablet:p-10">
                  <h3 className="font-aeonikFono text-[32px] font-bold leading-[40px] tablet:text-[40px] tablet:leading-[48px] text-center tablet:max-w-[52%] tablet:text-left hidden tabletLg:hidden">Start learning to code on your phone</h3>
                  <h3 className="font-aeonikFono text-[32px] font-bold leading-[40px] tablet:text-[40px] tablet:leading-[48px] max-w-[50%] flex-1 text-left tablet:max-w-[48%] tablet:text-left tabletLg:block tabletLg:flex-1 desktop:max-w-[58%] desktopLg:max-w-[54%]">Start learning to code right now on your computer!</h3>
                  <a className="shrink-0 items-center justify-between rounded-xl bg-white px-4 py-4 text-[#252746] hover:bg-marketing-button-secondary-hover tabletLg:block">
                    <p className="font-aeonikFono text-[14px] leading-[20px] tablet:text-[16px] tablet:leading-[24px] font-bold">Start learning</p>
                  </a>
            ...
            <section className="mt-20 px-6 tablet:mt-24 tablet:px-10">
              <div className="relative z-10 grid grid-flow-row grid-cols-3 justify-center gap-y-12 text-white tablet:grid-cols-2 tablet:gap-x-10 tablet:gap-y-16 tabletLg:grid-cols-3 tabletLg:gap-x-8">
                ...
                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                  <svg height="100%" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-[60px] tablet:h-20">
                    <path d="M61.5 14C55.92 14 51.11 17.27 48.87 22H32.13C29.88 17.27 25.08 14 19.5 14C11.77 14 5.5 20.27 5.5 28V58.58C5.5 62.68 8.82 66 12.92 66C15.73 66 18.3 64.41 19.55 61.9L24.5 52H56.5L61.45 61.9C62.71 64.41 65.27 66 68.08 66C72.18 66 75.5 62.68 75.5 58.58V28C75.5 20.27 69.23 14 61.5 14Z" fill="#FF7231"></path>
                    ...
                    <path d="M17.5 22V26H13.5V30H17.5V34H21.5V30H25.5V26H21.5V22H17.5Z" fill="#252746"></path>
                  </svg>
                  <div className="flex-1 space-y-4">
                    <h5 className="font-aeonikFono text-[20px] font-bold leading-[28px] tablet:text-[24px] tablet:leading-[32px]">Gamified lessons</h5>
                    <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">Learn with interactive exercises, challenges, and projects, crafted by learning experts and backed by research</p>
                  </div>
                </div>
                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                  <svg height="100%" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-[60px] tablet:h-20">
                    <path d="M65.5 10H15.5C9.97715 10 5.5 14.4772 5.5 20V60C5.5 65.5228 9.97715 70 15.5 70H65.5C71.0229 70 75.5 65.5228 75.5 60V20C75.5 14.4772 71.0229 10 65.5 10Z" fill="white"></path>
                  ...
                  <div className="flex-1 space-y-4">
                    <h5 className="font-aeonikFono text-[20px] font-bold leading-[28px] tablet:text-[24px] tablet:leading-[32px]">Real-world projects</h5>
                    <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">Build projects that apply your coding skills in real-life scenarios</p>
                  </div>
                </div>
                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                  <svg height="100%" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-[60px] tablet:h-20">
                    <path d="M73.9999 44.75L67.9499 48.92L70.3899 55.85C71.7399 59.66 68.8399 63.64 64.7999 63.54L57.4499 63.35L55.3599 70.39C54.2099 74.27 49.5299 75.79 46.3099 73.33L40.4799 68.86L34.6499 73.33C31.4399 75.79 26.7599 74.27 25.6099 70.39L23.5199 63.35L16.1699 63.54C12.1299 63.64 9.23991 59.66 10.5799 55.85L13.0199 48.92L6.96991 44.75C3.63991 42.46 3.63991 37.54 6.96991 35.25L13.0199 31.08L10.5799 24.15C9.22991 20.34 12.1299 16.36 16.1699 16.46L23.5199 16.65L25.6099 9.61C26.7599 5.73 31.4399 4.21 34.6599 6.67L40.4899 11.14L46.3199 6.67C49.5299 4.21 54.2099 5.73 55.3599 9.61L57.4499 16.65L64.7999 16.46C68.8399 16.36 71.7299 20.34 70.3899 24.15L67.9499 31.08L73.9999 35.25C77.3299 37.54 77.3299 42.46 73.9999 44.75Z" fill="#7E4BDE"></path>
                    <path d="M50.5 45.74V49.74H54.5V45.74H50.5Z" fill="#252746"></path>
                    <path d="M42.5 26V34H46.5V26H42.5Z" fill="#252746"></path>
                    <path d="M34.5 46V54H38.5V46H34.5Z" fill="#252746"></path>
                    <path d="M54.5 41.74V45.74H58.5V41.74H54.5Z" fill="#252746"></path>
                    <path d="M58.5 37.74V41.74H62.5V37.74H58.5Z" fill="#252746"></path>
                    <path d="M54.5 33.74V37.74H58.5V33.74H54.5Z" fill="#252746"></path>
                    <path d="M50.5 29.74V33.74H54.5V29.74H50.5Z" fill="#252746"></path>
                  ...
                  <div className="flex-1 space-y-4">
                    <h5 className="font-aeonikFono text-[20px] font-bold leading-[28px] tablet:text-[24px] tablet:leading-[32px]">Certificates</h5>
                    <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">Celebrate your accomplishments with shareable certificates as you reach milestones on your journey</p>
                  </div>
                </div>
                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                  <svg height="100%" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-[60px] tablet:h-20">
                    <path d="M74.5 13H63.5V10C63.5 7.79 61.71 6 59.5 6H21.5C19.29 6 17.5 7.79 17.5 10V13H6.5C4.84 13 3.5 14.34 3.5 16V28C3.5 36.27 10.23 43 18.5 43H19.66C22.61 48.84 28.34 53.04 35.12 53.84L34.5 59.99H28.5C26.29 59.99 24.5 61.78 24.5 63.99V69.99C24.5 72.2 26.29 73.99 28.5 73.99H52.5C54.71 73.99 56.5 72.2 56.5 69.99V63.99C56.5 61.78 54.71 59.99 52.5 59.99H46.5L45.88 53.84C52.66 53.03 58.38 48.84 61.34 43H62.5C70.77 43 77.5 36.27 77.5 28V16C77.5 14.34 76.16 13 74.5 13ZM9.5 28V19H17.5V34C17.5 35.01 17.6 35.99 17.74 36.96C13.13 36.57 9.5 32.71 9.5 28ZM71.5 28C71.5 32.71 67.87 36.57 63.26 36.96C63.4 35.99 63.5 35.01 63.5 34V19H71.5V28Z" fill="#F4D055"></path>
                    <path d="M34.5 20H38.5V16H42.5V36H46.5V40H34.5V36H38.5V24H34.5V20Z" fill="#252746"></path>
                  </svg>
                  <div className="flex-1 space-y-4">
                    <h5 className="font-aeonikFono text-[20px] font-bold leading-[28px] tablet:text-[24px] tablet:leading-[32px]">Leaderboards</h5>
                    <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">Compete with fellow learners and climb the ranks as you complete exercises, challenges, and projects</p>
                  </div>
                </div>
                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                  <svg height="100%" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-[60px] tablet:h-20">
                    <path d="M6.5 62V18C6.5 12.48 10.98 8 16.5 8H31.83C33.42 8 34.95 8.63 36.07 9.76L41.83 15.52C42.96 16.65 44.48 17.28 46.07 17.28H64.49C70.01 17.28 74.49 21.76 74.49 27.28V62C74.49 67.52 70.01 72 64.49 72H16.5C10.98 72 6.5 67.52 6.5 62Z" fill="#78D86B"></path>
                    <path d="M50.5 49.74V53.74H54.5V49.74H50.5Z" fill="#252746"></path>
                    <path d="M42.5 30V38H46.5V30H42.5Z" fill="#252746"></path>
                    <path d="M34.5 50V58H38.5V50H34.5Z" fill="#252746"></path>
                    <path d="M54.5 45.74V49.74H58.5V45.74H54.5Z" fill="#252746"></path>
                    <path d="M58.5 41.74V45.74H62.5V41.74H58.5Z" fill="#252746"></path>
                    <path d="M54.5 37.74V41.74H58.5V37.74H54.5Z" fill="#252746"></path>
                    <path d="M50.5 33.74V37.74H54.5V33.74H50.5Z" fill="#252746"></path>
                  ...
                  <div className="flex-1 space-y-4">
                    <h5 className="font-aeonikFono text-[20px] font-bold leading-[28px] tablet:text-[24px] tablet:leading-[32px]">Playgrounds</h5>
                    <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">Unleash your creativity, from trying out concepts to prototyping your ideas and realizing your projects</p>
                  </div>
                </div>
                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                  <svg height="100%" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-[60px] tablet:h-20">
                    <path d="M40.5 75C59.83 75 75.5 59.33 75.5 40C75.5 20.67 59.83 5 40.5 5C21.17 5 5.5 20.67 5.5 40C5.5 59.33 21.17 75 40.5 75Z" fill="#3890FA"></path>
                    <path d="M58.5 21V25H62.5V21H58.5Z" fill="#252746"></path>
                    <path d="M32.5 9V13H28.5V17H20.5V21H16.5V25H12.5V29H20.5V37H24.5V49H28.5V69H32.5V65H36.5V57H40.5V53H44.5V49H48.5V45H44.5V41H36.5V37H24.5V29H28.5V25H36.5V17H40.5V9H32.5Z" fill="#252746"></path>
                    <path d="M54.5 29H66.5V33H70.5V45H66.5V49H62.5V45H58.5V37H50.5V33H54.5V29Z" fill="#252746"></path>
                  </svg>
                  <div className="flex-1 space-y-4">
                    <h5 className="font-aeonikFono text-[20px] font-bold leading-[28px] tablet:text-[24px] tablet:leading-[32px]">Community</h5>
                    <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">Connect with the community to get guidance, share insights, and collaborate with your fellow learners</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mt-20 tablet:mt-40 tablet:px-10">
              <div className="relative z-10 space-y-6">
                ...
                <div className="grid grid-cols-2 w-full tablet:grid tablet:grid-cols-1 tablet:gap-6 desktop:grid-cols-2 px-10 gap-10">
                  <div>
                    <h2 className="font-aeonikFono text-[40px] font-bold leading-[52px] tablet:text-[56px] tablet:leading-[64px] mb-16 pl-6 text-white tablet:pl-0">Mimo learners have inspiring stories to tell</h2>
                  </div>
                  <div className="relative flex max-h-[460px] min-w-[342px] snap-center rounded-3xl tablet:max-h-[300px] tablet:flex-row [&:nth-child(3)]:relative [&:nth-child(3)]:after:absolute [&:nth-child(3)]:after:-right-6 [&:nth-child(3)]:after:h-full [&:nth-child(3)]:after:w-6 [&:nth-child(3)]:after:content-[''] tablet:[&:nth-child(3)]:after:-right-10 tablet:[&:nth-child(3)]:after:hidden tablet:[&:nth-child(3)]:after:w-10">
                    <div className="max-h-[200px] overflow-auto rounded-l-3xl tablet:h-full tablet:max-h-full tablet:w-[180px] tablet:rounded-t-none">
                      <svg width="50" height="40" viewBox="0 0 50 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute left-5 top-5">
                        ...
                        <rect x="10" y="30" width="10" height="10" fill="white"></rect>
                        ...
                        <rect x="40" y="30" width="10" height="10" fill="white"></rect>
                        <rect x="40" y="30" width="10" height="10" fill="white"></rect>
                      </svg>
                      <img alt="Portrait photo of the auther of the quote" loading="lazy" width="540" height="840" decoding="async" data-nimg="1" className="h-full w-full self-center object-cover" style={{color: 'transparent'}} srcSet="https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_1.64795b80.png&w=640&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm 1x, https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_1.64795b80.png&w=640&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm 2x" src="https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_1.64795b80.png&w=640&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm"></img>
                    </div>
                    <div className="relative z-20 flex flex-1 flex-shrink flex-col justify-between space-y-10 rounded-r-3xl bg-[#3F4273] p-6 text-white tablet:space-y-6 tablet:rounded-r-3xl tablet:rounded-bl-none tablet:p-10 max-h-[200px]">
                      <p className="font-mimopro text-[20px] font-normal italic leading-[28px] tablet:text-[24px] tablet:leading-[32px]">“The coding skills acquired through Mimo's courses made me feel more confident about my ability to code and create software.”</p>
                      <div className="flex justify-between">
                        <p className="font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[20px] tablet:leading-[24px]">Clément Durandeau</p>
                        <p className="font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[20px] tablet:leading-[24px]">🇫🇷 France</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative flex max-h-[460px] min-w-[342px] snap-center rounded-3xl tablet:max-h-[300px] tablet:flex-row [&:nth-child(3)]:relative [&:nth-child(3)]:after:absolute [&:nth-child(3)]:after:-right-6 [&:nth-child(3)]:after:h-full [&:nth-child(3)]:after:w-6 [&:nth-child(3)]:after:content-[''] tablet:[&:nth-child(3)]:after:-right-10 tablet:[&:nth-child(3)]:after:hidden tablet:[&:nth-child(3)]:after:w-10">
                    <div className="max-h-[200px] overflow-auto rounded-l-3xl tablet:h-full tablet:max-h-full tablet:w-[180px] tablet:rounded-t-none">
                      ...
                      <img alt="Portrait photo of the auther of the quote" loading="lazy" width="540" height="840" decoding="async" data-nimg="1" className="h-full w-full self-center object-cover" style={{color: 'transparent'}} srcSet="https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_2.7e3e0c73.png&w=640&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm 1x, https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_2.7e3e0c73.png&w=640&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm 2x" src="https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_2.7e3e0c73.png&w=640&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm"></img>
                    </div>
                    <div className="relative z-20 flex flex-1 flex-shrink flex-col justify-between space-y-10 rounded-r-3xl bg-[#3F4273] p-6 text-white tablet:space-y-6 tablet:rounded-r-3xl tablet:rounded-bl-none tablet:p-10 max-h-[200px]">
                      <p className="font-mimopro text-[20px] font-normal italic leading-[28px] tablet:text-[24px] tablet:leading-[32px]">“My goal is to learn how to code so that when I re-enter the workforce, I'll be a more competitive job candidate.”</p>
                      <div className="flex justify-between">
                        <p className="font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[20px] tablet:leading-[24px]">Stephanie Tyers</p>
                        <p className="font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[20px] tablet:leading-[24px]">🇺🇸 USA</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative flex max-h-[460px] min-w-[342px] snap-center rounded-3xl tablet:max-h-[300px] tablet:flex-row [&:nth-child(3)]:relative [&:nth-child(3)]:after:absolute [&:nth-child(3)]:after:-right-6 [&:nth-child(3)]:after:h-full [&:nth-child(3)]:after:w-6 [&:nth-child(3)]:after:content-[''] tablet:[&:nth-child(3)]:after:-right-10 tablet:[&:nth-child(3)]:after:hidden tablet:[&:nth-child(3)]:after:w-10">
                    <div className="max-h-[200px] overflow-auto rounded-l-3xl tablet:h-full tablet:max-h-full tablet:w-[180px] tablet:rounded-t-none">
                      ...
                      <img alt="Portrait photo of the auther of the quote" loading="lazy" width="540" height="840" decoding="async" data-nimg="1" className="h-full w-full self-center object-cover" style={{color: 'transparent'}} srcSet="https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_4.da15e67e.png&w=1920&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm 1x, https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_4.da15e67e.png&w=1920&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm 2x" src="https://mimo.org/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftestament_4.da15e67e.png&w=1920&q=75&dpl=dpl_7yUgU2fvNHmcQo25eftjUc8AkoZm"></img>
                    </div>
                    <div className="relative z-20 flex flex-1 flex-shrink flex-col justify-between space-y-10 rounded-r-3xl bg-[#3F4273] p-6 text-white tablet:space-y-6 tablet:rounded-r-3xl tablet:rounded-bl-none tablet:p-10 max-h-[200px]">
                      <p className="font-mimopro text-[20px] font-normal italic leading-[28px] tablet:text-[24px] tablet:leading-[32px]">“I've tried quite a few coding platforms but none of them matched the ease of learning I experienced with Mimo.”</p>
                      <div className="flex justify-between">
                        <p className="font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[20px] tablet:leading-[24px]">Sam Phelan</p>
                        <p className="font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[20px] tablet:leading-[24px]">🇺🇸 USA</p>
                      </div>
                    </div>
                  </div>
            ...
            <section className="mt-6 px-6 tablet:px-10">
              <div className="relative m-auto flex h-[200px] w-full max-w-[1364px]  items-center justify-around rounded-3xl bg-[#F4D055] px-8 py-10 text-black tablet:h-[200px] tablet:max-h-[200px] tablet:flex-row tablet:space-y-0 tablet:p-10">
                <h3 className="font-aeonikFono text-[32px] font-bold leading-[40px] tablet:text-[40px] tablet:leading-[48px] text-left tablet:max-w-[48%] tablet:text-left tabletLg:flex-1 desktopLg:max-w-[54%]">Learn to code anytime, from
                <br/>
                anywhere</h3>
                <svg height="100%" viewBox="0 0 131 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute right-[480px] h-[140px] tablet:right-[300px] tablet:h-[160px] tabletLg:right-[420px]">
                  <g clipPath="url(#clip0_1189_19506)">
                    <g opacity="0.2">
                      <path d="M24.1328 155.982H112.75" stroke="#252744" strokeWidth="8.08018" strokeLinecap="round"></path>
                    </g>
                    <path d="M54.4082 116.511C55.602 128.292 47.0269 138.794 35.2461 139.982" stroke="#A9ABCD" strokeWidth="21.8165" strokeMiterlimit="10" strokeLinecap="round"></path>
                    <path d="M35.2461 140L44.3363 147.424" stroke="#A9ABCD" strokeWidth="21.8165" strokeMiterlimit="10" strokeLinecap="round"></path>
                    <path d="M78.762 116.511L92.1184 143.709" stroke="#A9ABCD" strokeWidth="21.8165" strokeMiterlimit="10" strokeLinecap="round"></path>
                    <path d="M92.1741 143.678L101.264 139.218" stroke="#A9ABCD" strokeWidth="21.8165" strokeMiterlimit="10" strokeLinecap="round"></path>
                    <path d="M85.7926 0.146188L36.8269 4.42465C16.5438 6.20027 1.53893 24.0716 3.31454 44.3428L7.59904 93.2846C9.37465 113.556 27.252 128.555 47.5352 126.779L96.5008 122.494C116.784 120.719 131.789 102.847 130.013 82.5763L125.729 33.6346C123.953 13.3634 106.076 -1.62943 85.7926 0.146188Z" fill="#EBEBF3"></path>
                    <path d="M4.8787 41.1251L4.29087 41.1735C1.91531 41.3796 0.163938 43.4703 0.369982 45.8459L3.36974 80.0797C3.57578 82.4492 5.66652 84.2066 8.04208 84.0006L8.62991 83.9521C11.0055 83.7461 12.7568 81.6553 12.5508 79.2797L9.55105 45.046C9.345 42.6765 7.25427 40.919 4.8787 41.1251Z" fill="#EBEBF3"></path>
                    <path d="M92.4469 5.72818L43.4812 10.0066C26.5796 11.4853 14.0776 26.3812 15.5563 43.2708L16.6228 55.5062L17.6894 67.7417C19.1681 84.6374 34.0699 97.1334 50.9715 95.6547L99.9372 91.3762C116.839 89.8976 129.341 75.0017 127.862 58.1121L126.796 45.8767L125.729 33.6412C124.25 16.7455 109.349 4.2495 92.4469 5.72818Z" stroke="#EBEBF3" stroke-width="5.73288" stroke-miterlimit="10"></path>
                    <path d="M43.4872 10.0063L92.4529 5.72173C109.348 4.24305 124.256 16.7512 125.735 33.6348L126.808 45.8702L16.6288 55.4998L15.5562 43.2643C14.0775 26.3808 26.5916 11.4789 43.4811 10.0002L43.4872 10.0063Z" fill="#A9ABCD"></path>
                    <path d="M99.9493 91.376L50.9837 95.6606C34.0881 97.1393 19.1802 84.6311 17.7015 67.7475L16.6289 55.5121L126.802 45.8765L127.874 58.1119C129.353 74.9955 116.839 89.8974 99.9493 91.376Z" fill="#C5C7DD"></path>
                    <path d="M92.9939 11.8429L44.0283 16.1274C30.5081 17.3091 20.5029 29.2234 21.6846 42.7375L23.8238 67.2084C25.0056 80.7225 36.9258 90.7218 50.4459 89.54L99.4116 85.2555C112.932 84.0738 122.937 72.1595 121.755 58.6454L119.616 34.1745C118.434 20.6604 106.514 10.6612 92.9939 11.8429Z" fill="#282A47"></path>
                    <path d="M73.0547 65.9842L73.588 72.0989L79.7087 71.5656L79.1754 65.4448L73.0547 65.9781V65.9842Z" fill="#2EC3FF"></path>
                    <path d="M71.9805 53.7428L72.5138 59.8575L78.6345 59.3242L78.1012 53.2095L71.9805 53.7428Z" fill="#2EC3FF"></path>
                    <path d="M84.7633 58.7966L78.6426 59.3299L79.1759 65.4446L85.2966 64.9113L84.7633 58.7905V58.7966Z" fill="#2EC3FF"></path>
                    <path d="M72.5211 59.8691L66.4004 60.4024L66.9337 66.5171L73.0544 65.9838L72.5211 59.8691Z" fill="#2EC3FF"></path>
                    <path d="M59.475 51.7616L53.3543 52.2948L52.5483 43.1198C52.4028 41.429 50.906 40.1806 49.2213 40.3261C47.5305 40.4715 46.2761 41.9684 46.4276 43.6531L47.2336 52.8281L41.1129 53.3614L40.3069 44.1864C39.8645 39.1261 43.6218 34.6477 48.688 34.2053C53.7543 33.7629 58.2266 37.5202 58.6751 42.5804L59.4811 51.7555L59.475 51.7616Z" fill="#2EC3FF"></path>
                    <path d="M108.442 47.4759L102.321 48.0092L101.515 38.8341C101.37 37.1434 99.8728 35.895 98.188 36.0404C96.4973 36.1859 95.2428 37.6827 95.3943 39.3674L96.2003 48.5425L90.0796 49.0758L89.2736 39.9007C88.8312 34.8405 92.5946 30.3621 97.6547 29.9197C102.715 29.4773 107.193 33.2346 107.642 38.2948L108.448 47.4698L108.442 47.4759Z" fill="#2EC3FF"></path>
                    <path d="M33.2865 110.823C35.2946 110.823 36.9225 109.195 36.9225 107.187C36.9225 105.178 35.2946 103.551 33.2865 103.551C31.2783 103.551 29.6504 105.178 29.6504 107.187C29.6504 109.195 31.2783 110.823 33.2865 110.823Z" fill="#78D76B"></path>
                    <path d="M49.1968 114.289C52.5437 114.289 55.2569 111.576 55.2569 108.229C55.2569 104.882 52.5437 102.168 49.1968 102.168C45.8499 102.168 43.1367 104.882 43.1367 108.229C43.1367 111.576 45.8499 114.289 49.1968 114.289Z" fill="#A5A8CD"></path>
                    <path d="M67.3082 112.701C70.6551 112.701 73.3683 109.988 73.3683 106.641C73.3683 103.294 70.6551 100.581 67.3082 100.581C63.9613 100.581 61.248 103.294 61.248 106.641C61.248 109.988 63.9613 112.701 67.3082 112.701Z" fill="#A5A8CD"></path>
                  </g>
                  <defs>
                    <clipPath id="clip0_1189_19506">
                    <rect width="130.504" height="160" fill="white" transform="translate(0.353516)"></rect>
                    </clipPath>
                  </defs>
                </svg>
