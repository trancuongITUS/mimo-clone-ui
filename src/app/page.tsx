                                    ...
                                    <div className="flex flex-col items-baseline space-y-10 tablet:space-y-12 tabletLg:max-w-[430px] tabletLg:justify-center tabletLg:space-y-7 desktop:justify-center">
                                        ...
                                        <div className="w-full space-y-3 tabletLg:block">
                                            <div className="tabletLg:block">
                                                ...
                                                <p
                                                    className="font-mimopro font-normal flex h-6 items-center text-xs text-marketing-form-error"
                                                    style={{
                                                        color: rgbToHex(
                                                            "rgb(240, 90, 110)"
                                                        ),
                                                ...
                                                <div className="flex h-14 flex-col items-center space-y-3">
                                                    <button
                                                        className="flex h-full w-full items-center justify-center rounded-xl border border-transparent bg-primary-default-light px-4 py-2 text-base font-semibold text-text-reversed-light shadow-sm hover:bg-primary-state1-light focus:outline-none bg-[#7E4BDE]"
                                                        onClick={handleSignUp}
                                                        disabled={!agreed}
                                                        style={!agreed ? { cursor: "not-allowed" } : {}}
                                                    >
                                                        Sign up and learn for
                                                        free
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <section className="mt-4 space-y-20 tablet:mt-10  desktop:px-10">
                            <div className="px-8 tablet:block">
                                <h5 className="font-aeonikFono text-[20px] font-bold leading-[28px] tablet:text-[24px] tablet:leading-[32px] mb-8 text-center">
                                    Join 25+ million learners & start a career
                                    you’ll love
                                </h5>
                                ...
                                <div className="grid grid-flow-row grid-cols-2 pb-10 desktop:grid-cols-2 desktop:gap-4">
                                    <div className="space-y-6 text-left tablet:text-left tabletLg:w-full">
                                        <h2 className="font-aeonikFono text-[40px] font-bold leading-[52px] tablet:text-[56px] tablet:leading-[64px]">
                                            Python, JavaScript, HTML, CSS, and
                                            more
                                        </h2>
                                        <p className="font-mimopro text-[20px] font-normal leading-[30px] tablet:text-[24px] tablet:leading-[36px] md:w-full md:max-w-[50%] desktop:w-full desktop:max-w-full">
                                            ...
                                            hand-crafted by learning experts and
                                            backed by research
                                        </p>
                                    </div>
                                        ...
                                        >
                                            ...
                                            <div className="mt-10 flex grow flex-col space-y-4 tablet:space-y-6">
                                                ...
                                                <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                                    Discover the core of both
                                                    front-end and back-end
                                                    development. Learn to create
                                                    user interfaces and master
                                    ...
                                    <div className="relative flex items-end">
                                        ...
                                        >
                                            ...
                                            <div className="mt-10 flex grow flex-col space-y-4 tablet:space-y-6">
                                                ...
                                                <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                                    Dive into front-end
                                                    development using HTML, CSS,
                                                    and JavaScript. Learn to
                                                    craft web pages and use
                                                    React to develop engaging
                                                    user-focused web
                                                    applications.
                                                </p>
                                            </div>
                                    ...
                                    <div className="relative flex items-end">
                                        ...
                                        >
                                            ...
                                            <div className="mt-10 flex grow flex-col space-y-4 tablet:space-y-6">
                                                ...
                                                <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                                    Learn Python to quickly
                                                    develop anything from web
                                ...
                                <div className="grid auto-rows-auto grid-cols-3 gap-4 tablet:grid-cols-2 desktop:grid-cols-3">
                                    ...
                                    >
                                        ...
                                        <div className="group flex flex-grow flex-col space-y-4">
                                            ...
                                            <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px] flex-grow">
                                                CSS styles the appearance and
                                                layout of web pages, making them
                                    ...
                                    >
                                        ...
                                        <div className="group flex flex-grow flex-col space-y-4">
                                            ...
                                            <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px] flex-grow">
                                                ...
                                                language to manipulate web page
                                                elements, build web
                                    ...
                                    >
                                        ...
                                        <div className="group flex flex-grow flex-col space-y-4">
                                            ...
                                            <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px] flex-grow">
                                                Explore a beginner-friendly,
                                                popular programming language
                                                that’s renowned for its
                                                readability and extensive range
                                                of applications.
                                            </p>
                                        </div>
                                    </a>
                                    ...
                                    >
                                        ...
                                        <div className="group flex flex-grow flex-col space-y-4">
                                            ...
                                            <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px] flex-grow">
                                                Master SQL, an essential skill
                                                in data analysis and management,
                                                from creating to querying and
                                    ...
                                    >
                                        ...
                                        <div className="group flex flex-grow flex-col space-y-4">
                                            ...
                                            <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px] flex-grow">
                                                Apple’s language for building
                                                fast and safe apps across their
                                                devices, known for its
                        ...
                        <section className="mt-20 space-y-6 px-6 tablet:mt-32 tablet:px-10">
                            <div className="relative z-10 flex space-y-10 text-white flex-col">
                                ...
                                <div className="m-auto flex flex-col items-center space-y-4 text-center tabletLg:w-[800px]">
                                    ...
                                    <p className="font-mimopro text-[20px] font-normal leading-[30px] tablet:text-[24px] tablet:leading-[36px]">
                                        With Mimo, you can always choose the
                                        experience that suits you best – on
                                        <br />
                            ...
                            <div className="relative m-auto flex h-[200px] w-full max-w-[1364px] items-center justify-between space-y-6 rounded-3xl bg-[#7E4BDE] px-8 py-10 text-white tablet:h-[200px] tablet:max-h-[200px] tablet:flex-row tablet:space-y-0 tablet:space-y-6 tablet:p-10">
                                ...
                                <h3 className="font-aeonikFono text-[32px] font-bold leading-[40px] tablet:text-[40px] tablet:leading-[48px] max-w-[50%] flex-1 text-left tablet:max-w-[48%] tablet:text-left tabletLg:block tabletLg:flex-1 desktop:max-w-[58%] desktopLg:max-w-[54%]">
                                    Start learning to code right now on your
                                    computer!
                                </h3>
                            ...
                            <div className="relative z-10 grid grid-flow-row grid-cols-3 justify-center gap-y-12 text-white tablet:grid-cols-2 tablet:gap-x-10 tablet:gap-y-16 tabletLg:grid-cols-3 tabletLg:gap-x-8">
                                ...
                                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                                    ...
                                    >
                                        ...
                                        ></path>
                                        <path
                                            d="M55.5 26V30H59.5V26H55.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M63.5 26V30H67.5V26H63.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M63.5 22H59.5V26H63.5V22Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M63.5 30H59.5V34H63.5V30Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M46.5 40H34.5V44H46.5V40Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M46.5 36V40H50.5V36H46.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M30.5 36V40H34.5V36H30.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                            ...
                                            challenges, and projects, crafted by
                                            learning experts and backed by
                                            research
                                        </p>
                                    </div>
                                </div>
                                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                                    ...
                                    >
                                        ...
                                        ></path>
                                        <path
                                            d="M13.5 18V22H21.5V18H13.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M33.5 26V30H37.5V26H33.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M17.5 26V30H29.5V26H17.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M41.5 26V30H57.5V26H41.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M17.5 34V38H33.5V34H17.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M37.5 34V38H69.5V34H37.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M13.5 42V46H25.5V42H13.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M18.5 50V54H42.5V50H18.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M46.5 50V54H50.5V50H46.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M42.5 62V58H38.5V62H42.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M58.5 62V58H46.5V62H58.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M34.5 62V58H18.5V62H34.5Z"
                                            fill="#252746"
                                        ></path>
                                    </svg>
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                            Build projects that apply your
                                            coding skills in real-life scenarios
                                        </p>
                                    </div>
                                </div>
                                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                                    ...
                                    >
                                        ...
                                        ></path>
                                        <path
                                            d="M42.5 26V34H46.5V26H42.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M34.5 46V54H38.5V46H34.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                        ...
                                        ></path>
                                        <path
                                            d="M38.5 34V46H42.5V34H38.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M30.5 34V30H26.5V34H30.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M26.5 38V34H22.5V38H26.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M22.5 42V38H18.5V42H22.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M26.5 46V42H22.5V46H26.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M30.5 50V46H26.5V50H30.5Z"
                                            fill="#252746"
                                        ></path>
                                    </svg>
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                            Celebrate your accomplishments with
                                            shareable certificates as you reach
                                ...
                                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                            Compete with fellow learners and
                                            climb the ranks as you complete
                                ...
                                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                                    ...
                                    >
                                        ...
                                        ></path>
                                        <path
                                            d="M42.5 30V38H46.5V30H42.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M34.5 50V58H38.5V50H34.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                        ...
                                        ></path>
                                        <path
                                            d="M38.5 38V50H42.5V38H38.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M30.5 38V34H26.5V38H30.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M26.5 42V38H22.5V42H26.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M22.5 46V42H18.5V46H22.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M26.5 50V46H22.5V50H26.5Z"
                                            fill="#252746"
                                        ></path>
                                        <path
                                            d="M30.5 54V50H26.5V54H30.5Z"
                                            fill="#252746"
                                        ></path>
                                    </svg>
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                            Unleash your creativity, from trying
                                            out concepts to prototyping your
                                            ideas and realizing your projects
                                        </p>
                                    </div>
                                </div>
                                <div className="flex max-w-[370px] flex-col space-y-6 text-center">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <p className="font-mimopro text-[18px] font-normal leading-[28px] tablet:text-[20px] tablet:leading-[32px]">
                                            Connect with the community to get
                                            guidance, share insights, and
                                ...
                                <div className="grid grid-cols-2 w-full tablet:grid tablet:grid-cols-1 tablet:gap-6 desktop:grid-cols-2 px-10 gap-10">
                                    <div>
                                        <h2 className="font-aeonikFono text-[40px] font-bold leading-[52px] tablet:text-[56px] tablet:leading-[64px] mb-16 pl-6 text-white tablet:pl-0">
                                            Mimo learners have inspiring stories
                                            to tell
                                        </h2>
                                    </div>
                                    <div className="relative flex max-h-[460px] min-w-[342px] snap-center rounded-3xl tablet:max-h-[300px] tablet:flex-row [&:nth-child(3)]:relative [&:nth-child(3)]:after:absolute [&:nth-child(3)]:after:-right-6 [&:nth-child(3)]:after:h-full [&:nth-child(3)]:after:w-6 [&:nth-child(3)]:after:content-[''] tablet:[&:nth-child(3)]:after:-right-10 tablet:[&:nth-child(3)]:after:hidden tablet:[&:nth-child(3)]:after:w-10">
                                        ...
                                        <div className="relative z-20 flex flex-1 flex-shrink flex-col justify-between space-y-10 rounded-r-3xl bg-[#3F4273] p-6 text-white tablet:space-y-6 tablet:rounded-r-3xl tablet:rounded-bl-none tablet:p-10 max-h-[200px]">
                                            <p className="font-mimopro text-[20px] font-normal italic leading-[28px] tablet:text-[24px] tablet:leading-[32px]">
                                                “The coding skills acquired
                                                through Mimo's courses made me
                                                feel more confident about my
                                                ability to code and create
                                                software.”
                                            </p>
                                    ...
                                    <div className="relative flex max-h-[460px] min-w-[342px] snap-center rounded-3xl tablet:max-h-[300px] tablet:flex-row [&:nth-child(3)]:relative [&:nth-child(3)]:after:absolute [&:nth-child(3)]:after:-right-6 [&:nth-child(3)]:after:h-full [&:nth-child(3)]:after:w-6 [&:nth-child(3)]:after:content-[''] tablet:[&:nth-child(3)]:after:-right-10 tablet:[&:nth-child(3)]:after:hidden tablet:[&:nth-child(3)]:after:w-10">
                                        ...
                                        <div className="relative z-20 flex flex-1 flex-shrink flex-col justify-between space-y-10 rounded-r-3xl bg-[#3F4273] p-6 text-white tablet:space-y-6 tablet:rounded-r-3xl tablet:rounded-bl-none tablet:p-10 max-h-[200px]">
                                            <p className="font-mimopro text-[20px] font-normal italic leading-[28px] tablet:text-[24px] tablet:leading-[32px]">
                                                ...
                                                so that when I re-enter the
                                                workforce, I'll be a more
                                    ...
                                    <div className="relative flex max-h-[460px] min-w-[342px] snap-center rounded-3xl tablet:max-h-[300px] tablet:flex-row [&:nth-child(3)]:relative [&:nth-child(3)]:after:absolute [&:nth-child(3)]:after:-right-6 [&:nth-child(3)]:after:h-full [&:nth-child(3)]:after:w-6 [&:nth-child(3)]:after:content-[''] tablet:[&:nth-child(3)]:after:-right-10 tablet:[&:nth-child(3)]:after:hidden tablet:[&:nth-child(3)]:after:w-10">
                                        ...
                                        <div className="relative z-20 flex flex-1 flex-shrink flex-col justify-between space-y-10 rounded-r-3xl bg-[#3F4273] p-6 text-white tablet:space-y-6 tablet:rounded-r-3xl tablet:rounded-bl-none tablet:p-10 max-h-[200px]">
                                            <p className="font-mimopro text-[20px] font-normal italic leading-[28px] tablet:text-[24px] tablet:leading-[32px]">
                                                “I've tried quite a few coding
                                                platforms but none of them
                                                matched the ease of learning I
                                                experienced with Mimo.”
                                            </p>
                                            <div className="flex justify-between">
                                                <p className="font-mimopro text-[16px] font-normal leading-[20px] tablet:text-[20px] tablet:leading-[24px]">
                                                    Sam Phelan
